...
public class Rectangle
{
    ...
    public static bool RectIntersect(Rectangle first, Rectangle second)
    {
        ...
        if ((((firstPointAX <= secondPointBX) && (firstPointAX >= secondPointAX)) && 
            ((firstPointAY <= secondPointAY) && (firstPointAY >= secondPointDY))) ||
            (((firstPointBX <= secondPointBX) && (firstPointBX >= secondPointAX)) &&
            ((firstPointBY <= secondPointAY) && (firstPointBY >= secondPointDY))) ||
            (((firstPointCX <= secondPointBX) && (firstPointCX >= secondPointAX)) &&
            ((firstPointCY <= secondPointAY) && (firstPointCY >= secondPointDY))) ||
            (((firstPointDX <= secondPointBX) && (firstPointDX >= secondPointAX)) &&
            ((firstPointDY <= secondPointAY) && (firstPointDY >= secondPointDY))))
        {
            isIntersect = true;
        }
